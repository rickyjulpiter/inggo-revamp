        ...
        <Col>
          ...
          <Row className="mb-4">
            ...
            <Col md={11} className="text-justify">
              Hypnosis has been shown through a number of rigorously controlled studies to reduce
              ...
              sceptical of its power and uses. That scepticism has driven David Spiegel, a professor
              of psychiatry at Stanford University School of Medicine, USA, and other researchers to
              take a hard look at what happens in the brain during hypnosis. <br />
              ...
              suggestibility and relaxation. Spiegel belongs to the first school and over the years
              has had a debate with two scientists on the other side, Irving Kirsch, a University of
          ...
          <Row className="mb-4">
            ...
            <Col md={11} className="text-justify">
              ...
              ‘With hypnosis you do put people in altered states,’ he says. ‘But you don't need a
              ...
              hypnotized and given suggestion their brain wave patterns change, indicating that they
              had entered a trance. In one of his studies, people under hypnosis were told their
              forearms were numb, then given light electrical shocks to the wrists. They didn't
              flinch or respond in any way, and their brain waves resembles those of people who
              experienced a much weaker shock. To Kirsch this still wasn't enough to prove the power
              of trance, but Stephen Kosslyn was willing to be convinced. Many external factors
              could have been responsible for the shift in the subjects' state of mind, but Kosslyn
          ...
          <Row className="mb-4">
            ...
            <Col md={11} className="text-justify">
              To find out, Spiegel and Kosslyn decided to collaborate on a study focusing on a part
              of the brain that is well understood: the circuit which has been found to process the
              ...
              colour. Both tasks were then repeated under hypnosis. <br />
          ...
          <Row className="mb-4">
            ...
            <Col md={11} className="text-justify">
              ...
              use of hypnosis in the operating room just as he and Kosslyn did in the scanner.
              Spiegel and Lang took 241 patients scheduled for surgery and divided them into three
              groups. One group received standard care, another standard care with a sympathetic
              care provider and the third received standard care, a sympathetic care provider and
              hypnosis. Every 15 minutes the patients were asked to rate their pain and anxiety
              levels. They were also hooked up to painkilling medication which they could administer
              to themselves. <br />
              ...
              results published in The Lancet have been further supported by ongoing studies
              conducted by Lang.
            </Col>
          </Row>
          <Row className="mb-4">
            ...
            <Col md={11} className="text-justify">
              ...
              everyday use, physicians will need to know there is solid science behind what sounds
              like mysticism. Only then will their reluctance to using such things as mind over
              matter be overcome. ‘I agree that the medical use of hypnotism should be based on data
              rather than belief,’ says Spiegel, ‘but in the end it doesn't really matter why it
              works, as long as it helps our patients.’
            </Col>
          </Row>
        </Col>
        <Col>
