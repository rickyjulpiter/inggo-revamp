  ...
  return (
    <>
      ...
      <p className="text-justify">
        ...
        given surface to create images of its contours and textures, can penetrate jungle foliage
        and has produced the first map of the mountains of the planet Venus. And a combination of
        ...
        geography at the U.S. Bureau of the Census. ‘Our future as mapmakers - even ten years from
        now - is uncertain.
      </p>
      <p className="text-justify">
        The world's largest collection of maps resides in the basement of the Library of Congress in
        Washington, DC. The collection, consisting of up to 4.6 million map sheets and 63,000
        ...
        memories, computers are able to store data about people, places and environments - the stuff
        of maps - and almost instantly information is displayed on the screen in the desired
      ...
      <p className="text-justify">
        ...
        circumference as 25,200 miles, which was remarkably accurate. The longitudinal circumference
        is known today to be 24.860 miles.
      </p>
      <p className="text-justify">
        Building on the ideas of his predecessors, the astronomer and geographer Ptolemy, working in
        the second century AD, spelled out a system for organizing maps according to grids of
        latitude and longitude. Today, parallels of latitude are often spaced at intervals of 10 to
        20 degrees and meridians** at 15 degrees, and this is the basis for the width of modern time
        zones. Another legacy of Ptolemy’s is his advice to cartographers to create maps to scale.
        Distance on today's map is expressed as a fraction or ratio of the real distance. But
        ...
        satellites can plot potential missile targets within feet, maps are not true pictures of
        reality.{' '}
      </p>
      <p className="text-justify">
        However, just as the compass improved navigation and created demand for useful charts, so
        the invention of the printing press in the 15th century put maps in the hands of more
        people, and took their production away from monks, who had tended to illustrate theology
        rather than geography. Ocean-going ships launched an age of discovery, enlarging both what
        could and needed to be mapped, and awakened an intellectual spirit and desire for knowledge
        of the world.
      </p>
      <p className="text-justify">
        Inspired by the rediscovered Ptolemy, whose writing had been preserved by Arabs after the
        sacking of the Alexandrian Library in AD 931, mapmakers in the 15th century gradually
        replaced theology with knowledge of faraway places, as reported by traveling merchants like
        Marco Polo.
      </p>
      <p className="text-justify">
        ...
        formula, introduced on his world map of 1569, created the ‘Greenland problem’. Even on some
        standard map to this day, Greenland looks as large as South America - one of the many
        problems when one tries to portray a round world on a flat sheet of paper. But the Mercator
        projection was so practical that it is still popular with sailors.
      </p>
      <p className="text-justify">
        Scientific mapping of the land came into its own with the achievements of the Cassini family
        - father, son, grandson and great-grandson. In the late 17th Century, the Italian-born
        ...
        accurate map of France. The family continued to the French countryside and his
        great-grandson finally published their famous Cassini map in 1793 during the French
        Revolution. While it may have lacked the artistic appeal of earlier maps, it was the model
        of a social and geographic map showing roads, rivers, canals, towns, abbeys, vineyards,
        lakes and even windmills. With this achievement, France became the first country to be
        completely mapped by scientific methods.
      </p>
      <p className="text-justify">
        Mapmaking has come a long way since those days. Today’s surveyors rarely go into the field
        without being linked to navigation satellites. Their hand-held receivers are the most
        ...
        hikers, sailors and explorers can tap into it for data telling them where they are.
        Simplified civilian versions of the receivers are available for a few hundred dollars and
        they are also the heart of electronic map displays available in some cars. Cartography is
        pressing on to cosmic frontiers, but its objective is, and always has been, to communicate a
        sense of ‘here’ in relation to ‘there’, however far away ‘there’ may be.
      </p>
            ...
            <div className="mb-3">
              <Form
                onChange={(event) => {
                  ...
                  dispatch(updateReadingAnswer({ ...getAnswers, 14: value }));
                }}>
                <Form.Check
            ...
            <div className="mb-3">
              <Form
                onChange={(event) => {
                  ...
                  dispatch(updateReadingAnswer({ ...getAnswers, 15: value }));
                }}>
                <Form.Check
            ...
            <div className="mb-3">
              <Form
                onChange={(event) => {
                  ...
                  dispatch(updateReadingAnswer({ ...getAnswers, 16: value }));
                }}>
                <Form.Check
            ...
            <div className="mb-3">
              <Form
                onChange={(event) => {
                  ...
                  dispatch(updateReadingAnswer({ ...getAnswers, 17: value }));
                }}>
                <Form.Check
            ...
            <div className="mb-3">
              <Form
                onChange={(event) => {
                  ...
                  dispatch(updateReadingAnswer({ ...getAnswers, 18: value }));
                }}>
                <Form.Check
      ...
      <p className="text-justify">
        ...
        then abandoned for over a thousand years, during which time maps were the responsibility of
        <b> 23 </b>{' '}
        <input
          style={{ border: 'none' }}
          value={getAnswers[23]}
        ...
        />{' '}
        rather than scientists. Fortunately, however, the writings of <b> 24 </b>{' '}
        <input
          style={{ border: 'none' }}
          value={getAnswers[24]}
          onChange={(event) => {
        ...
        />{' '}
        are vital to the creation of maps and radar has allowed cartographers to map areas beyond
        our immediate world. In addition, this high-tech equipment is not only used to map faraway
        places, but cheaper versions have also been developed for use in <b> 26 </b>{' '}
        <input
          style={{ border: 'none' }}
          value={getAnswers[26]}
          onChange={(event) => {
