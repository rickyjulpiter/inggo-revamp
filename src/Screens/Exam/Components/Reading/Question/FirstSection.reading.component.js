        ...
        <Col>
          ...
          <Row className="mt-3">
            ...
            <Col className="text-justify">
              ...
              equal-weight basis, spider silk is far stronger than steel and it is estimated that if
              a single strand could be made about 10 m in diameter, it would be strong enough to
              stop a jumbo jet in flight. A third important factor is that it is extremely light.
              Army scientists are already looking at the possibilities of using it for lightweight,
          ...
          <Row className="mt-3">
            ...
            <Col className="text-justify">
              ...
              make, which is spun into a web. We then went looking for clones with the right DNA,’
              he says.
            </Col>
          </Row>
          <Row className="mt-3">
          ...
          <Row className="mt-3">
            ...
            <Col className="text-justify">
              ...
              spider uses in the drag lines of the web. The spider mixes the protein into a
              ...
              substituted man-made approaches and dissolved the protein in chemicals solvents, which
          ...
          <Row className="mt-3">
            ...
            <Col className="text-justify">
              ...
              They say the earthquake-resistant suspension bridges hung from cables of synthetic
              spider silk fibres may become a reality. Stronger ropes, safer seat belts, shoe soles
              that do not wear out so quickly and tough new clothing are among the other
              ...
              materials that can mimic both these properties. It is also a biological material with
              all the advantages that has over petrochemicals,’ he says.
            </Col>
          </Row>
          <Row className="mt-3">
            <Col md={1}>
